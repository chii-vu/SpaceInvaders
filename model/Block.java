...
/**
 * The model of a block that can withstand a certain number of hits before it is
 * destroyed.
 */
public class Block extends GameObject {
    ...
    /**
     * If a missile hits the block, change the image to show partial disintegration.
     * When the number

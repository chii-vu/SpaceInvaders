...
public class Missile extends GameObject {
    ...
    /**
     * Every clock tick, move MOVE_DISTANCE. Check for reaching the bottom or
    ...
    /**
     * Check for a collision with the player or a block, and if so, return the other
     * object of the
     * collision. Missiles do not hit invaders, explosions or other missiles. A
     * laser detects a
     * missile hit.
     * 
    ...
    protected void collide(GameObject other) {
        if (other instanceof Laser)
            ...
            Explosion explosion = new Explosion(x + WIDTH / 2 - Explosion.WIDTH / 2, y + HEIGHT

...
public class Controller implements KeyListener, ActionListener, GameObserver {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (actionCommand.equals("newgame")) {
            ...
            // invader window pop up
            InvaderFrame invaderFrame = new InvaderFrame(gameInfo);
            invaderFrame.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
    ...
    public void keyReleased(KeyEvent e) {
        switch (e.getKeyCode()) {
            case (KeyEvent.VK_A): // fall through to next case
            case (KeyEvent.VK_LEFT):
                gameControl.getPlayer().moveLeft();
                break;
            case (KeyEvent.VK_D): // fall through to next case

...
/**
 * A singleton that is a container storing images. When an image is to be
 * accessed, first search the
 * container. If it isn't found, read the image from disk and store it in the

...
/**
 * The panel to show the current game scene. It is an observer of the game model
 * in order to be
 * notified of changes, and it accesses information from the game via the
 * GameInfoProvider
 * interface.
 */
public class GamePanel extends GraphicsPanel implements GameObserver {
     ...
     * 
     * @param listener the listener for keystrokes
    ...
    /**
     * Paint the game scene on the panel: the background and sprites. If the game is
     * paused or is
